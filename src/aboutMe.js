  ...
  return (
    ...
    >
      ...
      <div style={{width:"60%",height:"350px", display:"flex",flexDirection:"column",alignItems:"center"}}>
        <div style={{marginTop:"25px", fontWeight:"750",color:"#147efb"}}>ABOUT ME</div>
          ...
          <div className='subheader' style={{fontSize:"15px",color:"grey",width:"80%",textAlign:"left",marginTop:"20px"}}>
